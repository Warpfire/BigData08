...
public class MapReduce3Test {
  ...
  @Before
  public void setUp() {
	  MapReduce3.LanguageMapper mapper   = new MapReduce3.LanguageMapper();
	  MapReduce3.LanguageReducer reducer = new MapReduce3.LanguageReducer();
  ...
  public void testMapper() {
    ...
    mapDriver.withOutput(new Text("done\tdone\t2014:07:03:10"), new Text("1"));
    mapDriver.runTest();
  }
  ...
  public void testReducer() {
    ...
    reduceDriver.withInput(new Text("nl\ten\t2014:07:03:10"), values);
    reduceDriver.withOutput(new Text("nl\ten\t2014:07:03:10"), new Text("6"));
  ...
  public void testMapReduce() {
    ...
    mapReduceDriver.withOutput(new Text("done\tdone\t2014:07:03:10"), new Text("1"));
