...
/**
 * Map Reduce to be done after MapReduce3 and calling -getmerge on the outputs.
...
public class MapReduce4 {
  ...
  public static class LanguageMapper 
    ...
    public void map(Object key, Text value, Context context
    	...
    	context.write(new Text(splitValue[0]+"\t"+splitValue[1]+"\t"+splitValue[2]), new Text(splitValue[3]));
    }
  }
